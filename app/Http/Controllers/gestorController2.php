...
class gestorController extends Controller
{
    ...
    function  verResultados(){
        ...
        if(isset($user->gestor->first()->exists)){
            ...
            // dd($user->gestor->first()->institucion->nino->respuestas);
            //moood::has('respuestas')->where('int_id',25)->get()
//              mood::whereHas('respuesta',function ($q) use(){
//                  $q->where('respuestas','<>',null)->where();
//              })
//                  ->where('int_id',25)
//                  ->get();
            //$ninos = $user::with('gestor')->get();
    ...
    function verResultadosById($idRes=0){
        ...
        $resultador = respuesta_nino::where('id','=',$idRes)->select('r1','r2','r3','r4','r5','r6','r7','r8','r9','r10','r11','r12','r13','r14','r15','r16','r17')->get();

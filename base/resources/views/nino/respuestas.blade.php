        ...
        <div class="content">
            <table id="example1" class="table table-bordered table-striped">
                ...
                @forelse($respuestaGenerales as $respuesta)
                    ...
                    <tr 
                     data-nombre="{{$respuesta['user']->nombres}}"
                     data-apellido="{{$respuesta['user']->apellidos}}" 
                     data-acertadad="{{$respuesta['respuesta']->acertadas}}" 
                     data-neutras="{{$respuesta['respuesta']->neutras}}" 
                     data-negativas="{{$respuesta['respuesta']->negativas}}">
                       ...
                       <td style="text-align: center">
                            <button type="button"  class="btn btn-default botonShowResponseById" aria-label="Left Align" data-id="{{$respuesta['respuesta']->id}}" data-toggle="modal" data-target="#exampleModal" >
                                <span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>
                            </button>

                            <button type="button"   class="btn btn-default botonDonwloadResponse" aria-label="Left Align" data-parametro="{{$respuesta['respuesta']->id}}"  >
...
@section('script')
    <script>
        ...
        $('document').ready(function(){
            ...
            $(".botonDonwloadResponse").click(function (e) {
    // Obtener el valor del parámetro del atributo de datos del botón
    e.preventDefault();
    var parametro = this.getAttribute("data-parametro");
    
    // Generar la URL con el parámetro
    var url = "{{ route('informes', ['id' => ':USER_ID']) }}";
    url = url.replace(':USER_ID', parametro);
    console.log(url);
    ...
    $.get(url, function(respuesta) {
        ...
        enlace.href = url; // Asignar la URL del archivo PDF
        ...
        // Ocultar el modal de carga después de completar la descarga
        $('#modalCarga').modal('hide');
    });
});


            $('.botonShowResponseById').click(function (e) {
